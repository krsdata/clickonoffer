            ...
            <div class="panel panel-white"> 
                  ...
                  <div class="panel-heading">
                    ...
                    <div class="heading-elements">
                      <ul class="icons-list">
                        <li> <a type="button" href="{{route('categories.create')}}" class="btn btn-primary text-white btn-labeled btn-rounded "><b><i class="icon-plus3"></i></b> Add Category<span class="legitRipple-ripple" ></span></a></li> 
                      </ul>
                    </div>
                  </div> 
  		        </div>  
                              ...
                              <tr>
                               ...
                               <td><a href="{{asset('public/'.$result->image) }}"> <img width="100" src="{{asset('public/'.$result->image) }}" ></a> </td>
								 ...
								 <td> {{$result->description }} </td>
                                  ...
                                  <td> 
                                      <a href="{{ route('categories.edit',$result->id)}}" class="btn btn-primary btn-xs" style="margin-left: 20px">
                                          <i class="fa fa-edit" title="edit"></i> Edit
                                      </a>

                                      {!! Form::open(array('class' => 'form-inline pull-left deletion-form', 'method' => 'DELETE',  'id'=>'deleteForm_'.$result->id, 'route' => array('categories.destroy', $result->id))) !!}
